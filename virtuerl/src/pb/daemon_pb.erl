...
-export_type(['sync_routes_request'/0, 'empty'/0, 'start_domain_request'/0, 'stop_domain_request'/0, 'get_domain_request'/0, 'domain'/0, 'list_domains_request'/0, 'list_domains_response'/0, 'create_domain_request'/0, 'delete_domain_request'/0, 'download_image_request'/0, 'image_chunk'/0, 'get_network_request'/0, 'network'/0, 'list_networks_request'/0, 'list_networks_response'/0, 'create_network_request'/0, 'delete_network_request'/0, 'get_volume_request'/0, 'volume'/0, 'list_volumes_request'/0, 'list_volumes_response'/0, 'create_volume_request'/0, 'update_volume_request'/0, 'delete_volume_request'/0, 'volume_attachment_identifier'/0, 'volume_attachment'/0, 'list_volume_attachments_request'/0, 'list_volume_attachments_response'/0, 'port_forwarding_identifier'/0, 'port_forwarding'/0, 'list_port_forwardings_request'/0, 'list_port_forwardings_response'/0, 'put_port_forwarding_request'/0, 'timestamp'/0]).
-type '$msg_name'() :: sync_routes_request | empty | start_domain_request | stop_domain_request | get_domain_request | domain | list_domains_request | list_domains_response | create_domain_request | delete_domain_request | download_image_request | image_chunk | get_network_request | network | list_networks_request | list_networks_response | create_network_request | delete_network_request | get_volume_request | volume | list_volumes_request | list_volumes_response | create_volume_request | update_volume_request | delete_volume_request | volume_attachment_identifier | volume_attachment | list_volume_attachments_request | list_volume_attachments_response | port_forwarding_identifier | port_forwarding | list_port_forwardings_request | list_port_forwardings_response | put_port_forwarding_request | timestamp.
-type '$msg'() :: sync_routes_request() | empty() | start_domain_request() | stop_domain_request() | get_domain_request() | domain() | list_domains_request() | list_domains_response() | create_domain_request() | delete_domain_request() | download_image_request() | image_chunk() | get_network_request() | network() | list_networks_request() | list_networks_response() | create_network_request() | delete_network_request() | get_volume_request() | volume() | list_volumes_request() | list_volumes_response() | create_volume_request() | update_volume_request() | delete_volume_request() | volume_attachment_identifier() | volume_attachment() | list_volume_attachments_request() | list_volume_attachments_response() | port_forwarding_identifier() | port_forwarding() | list_port_forwardings_request() | list_port_forwardings_response() | put_port_forwarding_request() | timestamp().
...
get_service_names() -> ['DaemonService', 'DomainService', 'VolumeService', 'PortForwardingService'].
...
get_all_source_basenames() -> ["daemon.proto", "empty.proto", "domain.proto", "volume.proto", "port_forwarding.proto", "timestamp.proto"].
...
%% functions.
get_all_proto_names() -> ["daemon", "empty", "domain", "volume", "port_forwarding", "timestamp"].
